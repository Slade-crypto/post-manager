...
public class UsersController extends HttpServlet{
	...
	private void updateUser(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
			if (dao.update(user)) {
				ControllerUtil.sucessMessage(req, "Usuario '" + user.getName() + "' atualizado com sucesso.");
			}
			else {
				ControllerUtil.errorMessage(req, "Usuario '" + user.getName() + "' n�o pode ser atualizado.");
			}
