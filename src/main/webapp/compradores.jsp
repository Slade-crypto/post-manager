	 	 	...
	 	 	<div id="top" class="row">
			    ...
			    <div class="col-md-6">
			        <div class="input-group h2">
			            <input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar compradores">
			    ...
			    <div class="col-md-3">
			        <a href="/post-manager/compradores/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Comprador</a>
			    </div>
	     	</div>
	     	...
	     	<div id="list" class="row">
	     		<div class="table-responsive col-md-12">
			        <table class="table table-striped table-hover" cellspacing="0" cellpadding="0">
			            ...
			            <tbody>
			            	<c:forEach var="compradores" items="${compradores}">
								<tr>
		...
		<script type="text/javascript">
			$(document).ready(function() {
			    ...
			    $(".modal-remove").click(function () {
		            var compradorName = $(this).attr('comprador-name');
